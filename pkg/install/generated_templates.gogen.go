...
var templates = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 8, 6, 14, 14, 33, 287261328, time.UTC),
		},
		"/flux-helm-operator-account.yaml.tmpl.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "flux-helm-operator-account.yaml.tmpl.tmpl",
			modTime:          time.Date(2019, 8, 6, 14, 14, 33, 286733474, time.UTC),
		...
		"/flux-helm-release-crd.yaml.tmpl.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "flux-helm-release-crd.yaml.tmpl.tmpl",
			modTime:          time.Date(2019, 8, 6, 14, 4, 29, 363445744, time.UTC),
		...
		"/helm-operator-deployment.yaml.tmpl.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "helm-operator-deployment.yaml.tmpl.tmpl",
			modTime:          time.Date(2019, 8, 6, 14, 14, 33, 284032996, time.UTC),
	...
	fs["/"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		fs["/flux-helm-operator-account.yaml.tmpl.tmpl"].(os.FileInfo),
		fs["/flux-helm-release-crd.yaml.tmpl.tmpl"].(os.FileInfo),
		fs["/helm-operator-deployment.yaml.tmpl.tmpl"].(os.FileInfo),
	}
